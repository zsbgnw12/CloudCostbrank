...
async def integrity_error_handler(request: Request, exc: IntegrityError):
    ...
    # PostgreSQL: 23505 unique, 23503 foreign key（不依赖服务端语言）
...
app.include_router(azure_deploy.router, prefix="/api/azure-deploy", tags=["Azure Deploy"])
app.include_router(azure_consent.router, prefix="/api/azure-consent", tags=["Azure Consent"])
